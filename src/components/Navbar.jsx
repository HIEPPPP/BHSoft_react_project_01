            ...
            <div className="w-full max-w-[1140px] mx-auto pt-10 px-4 flex justify-between items-center">
                ...
                <ul
                    className={
                        !nav
                            ? "fixed left-[-100%]"
                            : "z-50 md:hidden fixed left-0 top-0 w-[60%] h-full pt-10 uppercase font-semibold text-white bg-gray-700 p-4 ease-in-out duration-500"
                    }
                >
                    <li>
                    ...
                    <li className="pt-4 ease-in-out duration-500 mt-3">
                        <a
                            href="#"
                            className="bg-gray-500 px-6 py-4 rounded-3xl hover:text-[#091156] hover:opacity-90 ease-in-out duration-500"
                        >
                            Contact
                        </a>
                    </li>
